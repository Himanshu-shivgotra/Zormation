        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <div className="py-20 lg:py-25">
            <div className="flex flex-wrap lg:justify-between gap-8 lg:gap-0">
              ...
              >
                ...
                {/* <!-- Company Description --> */}
                <p className="mt-5 mb-10 text-gray-700 dark:text-gray-300">
                  We are a team of experienced professionals specializing in delivering top-notch website development solutions. Our mission is to help businesses of all sizes and industries succeed online by providing customized, innovative, and effective web solutions tailored to their unique needs and goals.
                </p>

                {/* <!-- Contact Information --> */}
                <p className="uppercase tracking-[5px] text-sectiontitle mb-1.5 text-black dark:text-white">
                  Contact Us
                </p>
                <a
                  href="mailto:akpt2019@gmail.com"
                  className="text-black dark:text-white text-sm hover:text-primary dark:hover:text-primary transition-colors duration-300"
                >
                  akpt2019@gmail.com
                </a>
              </motion.div>
          ...
          <div className="border-t border-stroke dark:border-strokedark flex flex-wrap flex-col lg:flex-row items-center justify-center lg:justify-between gap-5 lg:gap-0 py-7">
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <p>&copy; {year} Zormation Pvt. Ltd. All rights reserved</p>
            </motion.div>

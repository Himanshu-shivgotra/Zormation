          ...
          >
            ...
            >
              ...
              <div className="lg:w-auto md:w-3/5">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Develop, integrate, and rigorously test for flawless execution.
                </p>
              </div>
            </div>

            {/* <!-- Tab 3: Deployment & Maintenance --> */}
            <div
            ...
            >
              ...
              <div className="lg:w-auto md:w-3/5">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                  Launch seamlessly and ensure ongoing performance optimization.
                </p>
              </div>
            </div>
          </motion.div>
